   ...
   if(isset($_POST['updatesubmit']))
                {
                  ...
                  if($img!='')
                  {
                    $ud="UPDATE admin SET Name='$na',email='$em',pass='$pa',img='$img'";
                    ...
                    $ud="UPDATE admin SET Name='$na',email='$em',pass='$pa'";
                    mysqli_query($conn,$ud);
                  } 
                }
?>
         ...
         <div class="col-10 bg-white">
            <div class="row bg-info">
              <div class="col-12 text-center border-bottom">
                <p class="text-danger font-weight-bold pt-2">Admin Details</p>
              </div>
            </div>
            <div class="row">
              <?php
                $sel="SELECT * FROM admin WHERE email='$adid'";
